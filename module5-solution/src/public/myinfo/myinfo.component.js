/* File: myinfo.component.js
 * Myinfo component definition.
 */
// Reminder:
...
(
    function() {
        ...
        angular.module('public')
            .component('myinfo', {
                templateUrl: 'src/public/myinfo/myinfo.component-template.html',
                //controller: automatically set up as '$ctrl' by AngularJS.
                bindings: {
                    boundRegInfo: '<',
                    boundIsRegistered: '<',
                    boundRetrievedDish: '<',
                    boundRetrievedDishImageURL: '<'
                }
            });
    }
)();
